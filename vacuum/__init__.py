...
async def async_setup(hass, config):
    ...
    component.async_register_entity_service(SERVICE_CLEAN_EDGE, {}, 'async_clean_edge')
...
class _BaseVacuum(Entity):
    ...
    async def async_clean_edge(self, **kwargs):
        ...
        This method must be run in the event loop.
        """
        await self.hass.async_add_executor_job(partial(self.clean_edge, **kwargs))
